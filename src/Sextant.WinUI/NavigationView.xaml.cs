...
namespace Sextant.WinUI
{
    ...
    public partial class NavigationView : IView, IEnableLogger
    {
        ...
        /// </summary>
        public static readonly DependencyProperty IsBackButtonVisibleProperty = DependencyProperty.Register("IsBackButtonVisible", typeof(bool), typeof(NavigationView), new PropertyMetadata(true));
        ...
        public IObservable<Unit> BackRequested => Observable.Merge(
            Observable
                .FromEvent<PointerEventHandler, PointerRoutedEventArgs>(
                    ...
                    x => PointerPressed -= x)
                .Where(args =>
                    args.GetCurrentPoint(this).Properties.PointerUpdateKind == PointerUpdateKind.XButton1Pressed)
                .Do(args =>
                {
